...
class CRelacion
{
    ...
    public function mostrarRelaciones(): void
    {
    ...
    public function agregarRelacion(int $usuarioA, int $usuarioB, int $tipoRelacionA, int $tipoRelacionB): void
    {
    ...
    public function editarRelacion(int $id, int $usuarioA, int $usuarioB, int $tipoRelacionA, int $tipoRelacionB): void
    {
    ...
    public function updateRelacion(int $id): void
    {
