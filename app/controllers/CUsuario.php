...
class CUsuario
{
    ...
    public function agregarUsuario(string $nombre, string $apellido, string $email, string $ci, int $cargo_id): void
    {
    ...
    public function editarUsuario(int $id, string $nombre, string $apellido, string $email, string $ci, int $cargo_id): void
    {
