...
class CEvento
{
    ...
    public function agregarEvento(string $nombre, string $fecha, string $descripcion, int $usuario_id): void
    {
    ...
    public function editarEvento(int $id, string $nombre, string $fecha, string $descripcion, int $usuario_id): void
    {
    ...
    public function updateEvento(int $id): void
    {
