...
<div style="display: flex; align-items: center; justify-content: center; margin-bottom: 5px;">
    ...
    <img src="/img/logo.jpg"  alt="logo"   style="display: block; height: 100px; padding: 5px; width: 100px; border-radius: 50%;" >
</div>
<a href="/" onclick="toggleDrawer('/'); return false;">Inicio</a>
